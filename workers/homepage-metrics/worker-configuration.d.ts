/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/homepage-metrics/wrangler.jsonc workers/homepage-metrics/worker-configuration.d.ts` (hash: 21ab82be0f902e6af80db473408aceef)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	HOMEPAGE_METRICS: KVNamespace;
}
